...
function makeMenuTransaltion(opts, menuId, elemId) {
  ...
  return __( ( !menuId || opts.i18nNoPrefix ? "" : menuId + "-") + elemId );
}
...
function makeSubmenu(ids, opts, menuId, id, url, attrs, entries, nolabel) {
...
Menu.prototype.render = function(jade, options, i18n, insertions) {
  ...
  return jade.render(mixins + code + '\n+Menu(__menu, __insertions, __attrsExtender)', opts);
};
