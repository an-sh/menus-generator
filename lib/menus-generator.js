...
Menu.prototype.getContent = function(i18n, skipCache) {
  var menu = this;
  return expand(menu, i18n, skipCache);
};

Menu.prototype.render = function(jade, options, i18n, insertions) {
  var skipMenuCache = options && options.skipCache ? options.skipCache : null;
  var menu = this.getContent(i18n, skipMenuCache);
